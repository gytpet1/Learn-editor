...
<!-- class="active main-link" -> apply on-click to the header categories-->
              <li class="main-link"><a href="">HTML <span class="sr-only"></span></a></li>
              <div class="pull-right media_margin"><img src="https://user-images.githubusercontent.com/23024110/29112292-1d56236c-7cf6-11e7-9210-b04d2a192d41.png"></div>
              ...
              <!--<li class="main-link"><a href="">CSS</a></li>
              <li class="active responsive-dropdown dropdown">
